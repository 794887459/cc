...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京东！[<a href="/MyJDShop/index.php/Home/User/login">登录</a>] [<a href="/MyJDShop/index.php/Home/User/register">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="/MyJDShop/Public/Home/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<?php if($headerControllerName != 'Index'): ?><!-- 非首页，需要添加cat1类 -->
				<div class="category fl cat1">  
				<?php else: ?><div class="category fl"><?php endif; ?>
			...
			<div class="navitems fl">
				<ul class="fl">
					...
					<?php if(is_array($headerFatherTypeArr)): foreach($headerFatherTypeArr as $key=>$v): if($_GET['typeid']== $v['typeid']): ?><li class="current"><a  href="/MyJDShop/index.php/Home/Product/typeList/typeid/<?php echo ($v["typeid"]); ?>"><?php echo ($v["typename"]); ?></a></li>
						<?php else: ?><li><a  href="/MyJDShop/index.php/Home/Product/typeList/typeid/<?php echo ($v["typeid"]); ?>"><?php echo ($v["typename"]); ?></a></li><?php endif; endforeach; endif; ?>
				</ul>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/MyJDShop/index.php/Home/Index/index">首页</a> > <a href="">电脑、办公</a></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="sort mt10">
				<dl>
					<dt>排序：</dt>
					<dd class="cur"><a href="/MyJDShop/index.php/Home/Product/typeList/">销量</a></dd>
					<dd><a href="">价格</a></dd>
					<dd><a href="">评论数</a></dd>
					<dd><a href="__">上架时间</a></dd>
				</dl>
			</div>
			<!-- 排序 end -->
			...
			<div class="goodslist mt10">
				...
				<?php if(is_array($productArr)): foreach($productArr as $key=>$v): ?><li>
						<dl>
							...
							<dd><a href=""><?php echo ($v["productname"]); ?></a></dt>
							<dd><strong>￥<?php echo ($v["price"]); ?></strong></dt>
							<dd><a href=""><em>已有<?php echo ($v["reviewnum"]); ?>条评价&nbsp;销量<?php echo ($v["salesnum"]); ?></em></a></dt>
						</dl>
