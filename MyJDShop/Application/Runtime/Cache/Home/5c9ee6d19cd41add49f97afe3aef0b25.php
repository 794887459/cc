	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
							<input type="text" class="txt" name="username" value="<?php echo ($post["username"]); ?>"/>
						</li>
						<li>
							<label for="">密码：</label>
						...
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="checkcode" placeholder="<?php echo ($info); ?>"/>
							<img src="/MyJDShop/index.php/Home/User/showCode" alt="" id="img"/>
							<span id="f5" style="margin-left:20px;cursor:pointer;color:#00f">看不清？ 换一张</span>
						</li>
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb"  name="info"/> 保存登录信息
						</li>
						<li>
							<label for="">&nbsp;</label>
			...
			<div class="guide fl">
				...
				<a href="/MyJDShop/index.php/Home/User/regist" class="reg_btn">免费注册 >></a>
			</div>
