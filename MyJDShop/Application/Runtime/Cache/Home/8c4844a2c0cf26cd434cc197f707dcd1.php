...
<body>
			...
			<div class="topnav_right fr">
				<ul>
					<?php if(!isset($_COOKIE['userid'])): ?><li>您好，欢迎来到京东！[<a href="/MyJDShop/index.php/Home/User/login">登录</a>] [<a href="/MyJDShop/index.php/Home/User/register">免费注册</a>] </li>
						...
						<li class="line">|</li>
						<li><a href="/MyJDShop/index.php/Home/User/logout">退出</a></li>
						<li class="line">|</li>
						<li>我的订单</li>
						<li class="line">|</li>
				...
				<dl>
					...
					<dd>
						...
						<div class="uclist mt10">
							<ul class="list1 fl">
								<li><a href="/MyJDShop/index.php/Home/User/userInfo">用户信息></a></li>
								<li><a href="">我的订单></a></li>
								<li><a href="">收货地址></a></li>
								<li><a href="">我的收藏></a></li>
							</ul>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/MyJDShop/index.php/Home/Index/index">首页</a> <?php echo ($nameStr); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/MyJDShop/Public/Home/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/MyJDShop/Public/Home/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/MyJDShop/Public/Home/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="list_top">
				...
				<div class="hotsale fl">
					...
					<?php if(is_array($hotProduct)): foreach($hotProduct as $key=>$v): ?><li>
							<dl>
								<dt><a href=""><img src="/MyJDShop/Public/upload/product/<?php echo ($v["imagename"]); ?>" alt="<?php echo ($v["productname"]); ?>" /></a></dt>
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					<dl>
						<dt>品牌：</dt>						
						<dd class="cur"><a href="/MyJDShop/index.php/Home/Product/ProductList/typeid/<?php echo ($_GET['typeid']); ?>">不限</a></dd>
						<?php if(is_array($brandArr)): foreach($brandArr as $key=>$v): if($_GET['brandid']== $v.brandid): ?><dd class="cur"><a href="/MyJDShop/index.php/Home/Product/ProductList/typeid/<?php echo ($_GET['typeid']); ?>/brandid/<?php echo ($v["brandid"]); ?>"><?php echo ($v["brandname"]); ?></a></dd>
								<?php else: ?><dd><a href="/MyJDShop/index.php/Home/Product/ProductList/typeid/<?php echo ($_GET['typeid']); ?>/brandid/<?php echo ($v["brandid"]); ?>"><?php echo ($v["brandname"]); ?></a></dd><?php endif; endforeach; endif; ?>
					</dl>
			...
			<div class="sort mt10">
				<dl>
					...
					<?php if($_GET['order']== asc): ?><!-- 如果get下的是asc那么点击后变desc -->
						<dd <?php if($_GET['field']== salesnum): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/salesnum/order/desc">销量</a></dd>	<!-- 传typeid 销量字段 -->
						<?php else: ?><dd <?php if($_GET['field']== salesnum): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/salesnum/order/asc">销量</a></dd><?php endif; ?>
					<!-- 根据价格排序 -->
					<?php if($_GET['order']== asc): ?><dd <?php if($_GET['field']== price): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/price/order/desc">价格</a></dd> <!-- 传typeid 价格字段 -->
						<?php else: ?><dd <?php if($_GET['field']== price): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/price/order/asc">价格</a></dd><?php endif; ?>
					<!-- 根据评论数排序 -->
					<?php if($_GET['order']== asc): ?><dd <?php if($_GET['field']== reviewnum): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/reviewnum/order/desc">评论数</a></dd>
						<?php else: ?><dd <?php if($_GET['field']== reviewnum): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/reviewnum/order/asc">评论数</a></dd><?php endif; ?>
					<!-- 根据上架时间排序 -->
					<?php if($_GET['order']== asc): ?><dd <?php if($_GET['field']== productid): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/productid/order/desc">上架时间</a></dd>
						<?php else: ?><dd <?php if($_GET['field']== productid): ?>class="cur"<?php endif; ?>><a href="/MyJDShop/index.php/Home/Product/productList/typeid/<?php echo ($_GET['typeid']); ?>/field/productid/order/asc">上架时间</a></dd><?php endif; ?>
				</dl>
			</div>
