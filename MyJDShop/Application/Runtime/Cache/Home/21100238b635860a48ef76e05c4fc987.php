		...
		<div class="nav w1210 bc mt10">
			...
			<div class="navitems fl">
				<ul class="fl">
					...
					<?php if(is_array($headerFatherTypeArr)): foreach($headerFatherTypeArr as $key=>$v): if($_GET['typeid']== $v['typeid']): ?><li class="current"><a  href="/MyJDShop/index.php/Home/GoodsTypes/typeList/typeid/<?php echo ($v["typeid"]); ?>"><?php echo ($v["typename"]); ?></a></li>
						<?php else: ?><li><a  href="/MyJDShop/index.php/Home/GoodsTypes/typeList/typeid/<?php echo ($v["typeid"]); ?>"><?php echo ($v["typename"]); ?></a></li><?php endif; endforeach; endif; ?>
				</ul>
			...
			<div class="goodslist mt10">
				...
				<?php if(is_array($productArr)): foreach($productArr as $key=>$v): ?><li>
						<dl>
							...
							<dd><a href=""><em>已有<?php echo ($v["reviewnum"]); ?>条评价</em></a></dt>
						</dl>
