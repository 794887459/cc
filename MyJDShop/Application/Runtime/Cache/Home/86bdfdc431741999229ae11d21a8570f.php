...
<head>
	...
	<link rel="stylesheet" href="/MyJDShop/Public/Home/style/goods.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/MyJDShop/Public/Home/style/jqzoom.css" type="text/css">
	...
	<script type="text/javascript" src="/MyJDShop/Public/Home/js/goods.js"></script>
	<script type="text/javascript" src="/MyJDShop/Public/Home/js/jqzoom-core.js"></script>
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> <?php echo ($nameStr); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo ($productArr["productname"]); ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
							<a href="/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[0]['imagename']); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
								<img src="/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[0]['imagename']); ?>" alt="" width="350px" height="350px"/>               <!-- 第一幅图片的中图 -->
							</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[0]['imagename']); ?>',largeimage: '/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[0]['imagename']); ?>'}">
									<img src="/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[0]['imagename']); ?>"></a>
								</li>
								
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[1]['imagename']); ?>',largeimage: '/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[1]['imagename']); ?>'}">
									<img src="/MyJDShop/Public/Upload/Product/<?php echo ($imageArr[1]['imagename']); ?>"></a>
								</li>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo ($productArr["productid"]); ?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo ($productArr["price"]); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($productArr["vipprice"]); ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo ($productArr["addtime"]); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?php echo ($productArr["reviewnum"]); ?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="/MyJDShop/index.php/Home/Cart_cookie/addCart" method="post" class="choose">
						<ul>
							<li class="product">
								<dl>
									<dt>颜色：</dt>
									<dd>
										<a class="selected" href="javascript:;">黑色 <input type="radio" value="黑色" name="style" checked="checked" /></a>
										<a href="javascript:;">白色 <input type="radio" value="白色" name="style"/></a>
										<a href="javascript:;">蓝色 <input type="radio" value="蓝色" name="style"/></a>
										<input type="hidden" name="vipprice" value="<?php echo ($productArr["vipprice"]); ?>" />
									</dd>
								</dl>
							</li>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<input type="hidden" name="productid" value="<?php echo ($productArr["productid"]); ?>"/>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="p-parameter">
							<?php echo ($productArr["content"]); ?>
						</div>
						<!-- 图片 -->
						<div class="desc mt10">
							<!-- 此处的内容 一般是通过在线编辑器添加保存到数据库，然后直接从数据库中读出 -->
							<?php echo ($productArr["style"]); ?>
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/MyJDShop/Public/Home/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/MyJDShop/Public/Home/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/MyJDShop/Public/Home/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
