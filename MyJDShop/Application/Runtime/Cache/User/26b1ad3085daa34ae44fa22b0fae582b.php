...
<head>
	...
	<link rel="stylesheet" href="/MyJDShop/Public/Home/style/address.css" type="text/css">
	...
	<div class="main w1210 bc mt10">
		...
		<div class="menu fl">
			<div class="menu_wrap">
				<dl>
					...
					<dd <?php if($method == history): ?>class="cur"<?php endif; ?>><b>.</b><a href="">浏览历史</a></dd>
				</dl>
		...
		<div class="content fl ml10">
			<div class="address_hd">
				<h3>收货地址薄</h3>
				<?php if(is_array($infoArr)): foreach($infoArr as $key=>$v): ?><dl>
						<dt><?php echo ($v["addr"]); ?> <?php echo ($v["phone"]); ?> </dt>
						<dd>
							<a href="/MyJDShop/index.php/User/User/addAddr/id/<?php echo ($v["id"]); ?>">修改</a>
							<a href="/MyJDShop/index.php/User/User/deleteAddr/id/<?php echo ($v["id"]); ?>">删除</a>
				...
				<form action="" name="address_form" method="post">
						<ul>
							<li>
								...
								<input type="text" name="name" class="txt" value="<?php echo ($thisArr["name"]); ?>"/>
							</li>
							<li>
							...
							<li>
								...
								<input type="text" name="addr" class="txt address"  value="<?php echo ($thisArr["addr"]); ?>"/>
							</li>
							<li>
								<label for=""><span>*</span>手机号码：</label>
								<input type="text" name="phone" class="txt" value="<?php echo ($thisArr["phone"]); ?>"/>
							</li>
							<li>
								<label for="">&nbsp;</label>
								<input type="checkbox" name="state" class="check" value=1 />设为默认地址
							</li>
							<li>
								<label for="">&nbsp;</label>
