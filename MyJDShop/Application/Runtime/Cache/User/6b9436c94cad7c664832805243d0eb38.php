			...
			<div class="user_bd mt10">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
							<strong><?php echo ($userArr["username"]); ?></strong>
						</li>
						<li>
							<label for="">昵称：</label>
							<input type="text" class="txt" value="<?php echo ($userArr["nickname"]); ?>" name="nickname"/>
						</li>
						<li>
							<label for="">邮箱：</label>
							<strong><?php echo ($userArr["email"]); ?></strong>
						</li>
						<li>
							<label for="">手机号码：</label>
							<input type="text" class="txt" value="<?php echo ($userArr["phone"]); ?>" name="phone"/>
						</li>
						<li>
							<label for="">&nbsp;</label>
